                    ...
                    >
                        ...
                        >
                            ...
                            <h1 className={`${styles.title}`}>
                                {titleCase(getAlbum.name)}
                            </h1>

                            <div
                                className={`${styles.subData} ${utilStyles.flexCol_NW}`}
                            >
                                <p className={`${styles.genreNames}`}>
                                    {titleCase(getAlbum.copyrights)}
                                </p>

                                <div
                                    className={`${styles.secondaryData} ${utilStyles.flexRow_Centre}`}
                                >
                                    <p>
                                        <span>Released in </span>
                                        {" " + getAlbum.release_date}
                                    </p>
                                    <div className={`${styles.dot}`}></div>
                                    <p>
                                        {getAlbum.albumTracks.length + " "}
                                        <span>Tracks</span>
                                    </p>
                                </div>
                            </div>
                            ...
                            >
                                ...
                                <p
                                    className={`${styles.artistNames} ${utilStyles.flexRow_NW}`}
                                >
